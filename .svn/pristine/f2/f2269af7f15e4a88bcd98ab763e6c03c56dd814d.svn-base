  ...
  <div>
    <basic-container>
      <p style="text-align: center;">
        ...
        <a target="_blank" href="https://crazyx.vip">
          <img src="https://img.shields.io/badge/Saber%20Author-Small%20Chill-ff69b4.svg" alt="Downloads"/>
        </a>
        <a target="_blank" href="https://crazyx.vip">
          <img src="https://img.shields.io/badge/Copyright%20-@CrazyX-%23ff3f59.svg" alt="Downloads"/>
        </a>
      </p>
    </basic-container>
    <el-col :span="16">
      <basic-container>
        <el-collapse v-model="activeNames" @change="handleChange">
          <el-collapse-item title="欢迎使用Saber" name="1">
            <div>1.Saber是SpringCrazy前端UI系统</div>
      ...
      <el-row>
        <basic-container>
          <div class="el-font-size">
            ...
            <span><el-tag>SpringCrazy企业级微服务开发平台</el-tag></span>
            ...
            <span>官网地址</span>
            <el-divider direction="vertical"/>
            <span><el-link href="https://crazyx.vip" target="_blank"
                           type="primary">https://crazyx.vip</el-link></span>
            <el-divider content-position="right"><i class="el-icon-star-off"/></el-divider>
            <span>社区地址</span>
            <el-divider direction="vertical"/>
            <span><el-link href="https://sns.crazyx.vip" target="_blank"
                           type="primary">https://sns.crazyx.vip</el-link></span>
            <el-divider content-position="right"><i class="el-icon-star-off"/></el-divider>
            <span>获取文档</span>
            <el-divider direction="vertical"/>
            <span class="tag-group">
                <el-tag type="success" style="cursor: pointer"
                        onclick="window.open('https://sns.crazyx.vip/note/view/1.html')">免费版</el-tag>
                <el-divider direction="vertical"/>
            ...
            <span class="tag-group">
                <el-tag type="success" effect="dark" style="cursor: pointer"
                        onclick="window.open('https://gitee.com/smallc/SpringCrazy')">开源版</el-tag>
                <el-divider direction="vertical"/>
                <el-tag type="danger" effect="dark" style="cursor: pointer"
                        onclick="window.open('https://crazyx.vip/#/vip')">商业版</el-tag>
              </span>
          </div>
        </basic-container>
      </el-row>
